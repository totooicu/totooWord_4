        ...
        <div class="chat-content">
          ...
          >
            ...
            <div class="message-content">
              ...
              <div class="message-time">{{OthersName[message.senderId]}}</div>
            </div>
            <!-- 自己头像 -->
            <el-avatar
                v-if="isSelf(message.senderId)"
...
props.item.data.otherUsers.forEach((item) => {
  OthersName[item.userId] = item.nickName;
})
...
const getAvatar = (userId) => {
  ...
  if (userId === props.item.data.self[0].userId) {
    url=  props.item.data.self[0].avatar;
  } else {
